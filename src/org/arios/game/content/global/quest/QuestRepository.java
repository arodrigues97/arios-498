...
import org.arios.game.content.global.quest.impl.member.TempleOfIkov;
import org.arios.game.content.global.quest.impl.member.TouristTrap;
import org.arios.game.content.global.quest.impl.member.TrollStronghold;
...
public final class QuestRepository implements SavingModule {
	...
	quests.put(DesertTreasure.NAME, new DesertTreasure(player));
	quests.put(TempleOfIkov.NAME, new TempleOfIkov(player));
	quests.put(Digsite.NAME, new Digsite(player));
	quests.put(TouristTrap.NAME, new TouristTrap(player));
	quests.put(TrollStronghold.NAME, new TrollStronghold(player));
