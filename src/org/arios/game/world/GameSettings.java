...
public final class GameSettings {
     ...
     */
    GameSettings(String name, boolean beta, boolean devMode, boolean gui, GameType type, int worldId, int countryIndex, boolean members, String msAddress) {
	this.name = name;
	this.beta = beta;
	...
	return new GameSettings(name, beta, devMode, gui, type, worldId, country, members, msAddress);
    }
	...
	return new GameSettings(properties.getProperty("name"), Boolean.parseBoolean(properties.getProperty("beta")), Boolean.parseBoolean(properties.getProperty("devMode")), Boolean.parseBoolean(properties.getProperty("gui")), GameType.forName(properties.getProperty("gameType")), Integer.parseInt(properties.getProperty("worldId")), Integer.parseInt(properties.getProperty("country")), Boolean.parseBoolean(properties.getProperty("members")), address);
    }
