...
public final class FaladorGardenerDialogue extends DialoguePlugin {
	...
	switch (stage) {
	case 0:
	    interpreter.sendDialogues(npc, FacialExpression.NORMAL, "Oi'm busy. If tha' wants owt, tha' can go find Wyson. He's", "ta boss 'round here. And KEEP YET TRAMPIN'FEETORFF", "MA'FLOWERS!");
	    stage = 1;
	    break;
	case 1:
