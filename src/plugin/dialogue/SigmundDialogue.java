...
public class SigmundDialogue extends DialoguePlugin {
	...
	case 21:
	    ...
	    break;
	case 22:
	    interpreter.sendDialogues(npc, FacialExpression.NORMAL, "I only advize the Duke. But if you want to make", "yourself useful, there are evil goblins to slay on the", "other side of the river.");
	    stage = 23;
	    break;
	case 23:
	    end();
