...
public final class TrollheimPlugin extends OptionHandler {
	...
	ObjectDefinition.forId(3759).getConfigurations().put("option:enter", this);// top
										   // cave.
	ObjectDefinition.forId(3771).getConfigurations().put("option:enter", this);// stronghold to herb patch
	ObjectDefinition.forId(18834).getConfigurations().put("option:climb-up", this);// stronghold ladder
	ObjectDefinition.forId(18833).getConfigurations().put("option:climb-down", this);// stronghold ladder
