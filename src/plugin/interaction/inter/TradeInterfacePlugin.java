...
public final class TradeInterfacePlugin extends ComponentPlugin {
	...
	case 335:// main accept interface
		...
		break;
	    case 235:// examine.
		if (TradeModule.getExtension(button == 34 ? module.getTarget() : player) == null) {
		    return true;
		}
		player.getPacketDispatch().sendMessage(TradeModule.getExtension(button == 34 ? module.getTarget() : player).getContainer().get(slot).getDefinition().getExamine());
		break;
	    }
	    break;
